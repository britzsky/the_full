...
// 메인 컴포넌트
// =====================================================================
function PersonPurchaseReceiptArchiveTab() {
  const now = new Date();
  const { rows, loading, fetchRows } = usePersonPurchaseReceiptArchiveData();
...
export default PersonPurchaseReceiptArchiveTab;
