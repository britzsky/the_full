...
import useHeadOfficeMembersheetData, {
  parseNumber,
  formatNumber,
} from "./headOfficeMemberSheetData";
import LoadingScreen from "layouts/loading/loadingscreen";

function HeadOfficeMemberSheetTab() {
  ...
  } = useHeadOfficeMembersheetData(selectedAccountId, activeStatus, selectedYear, selectedMonth);
...
export default HeadOfficeMemberSheetTab;
