// =====================================================================
// 영수증 마감 자료(현장 법인카드) 탭
// - 전체 거래처 현장 법인카드 영수증을 1회 API 호출로 조회
...
} from "./SiteCorpCardReceiptArchiveTabData";
...
// 메인 컴포넌트
// =====================================================================
function SiteCorpCardReceiptArchiveTab() {
  const now = new Date();
  const { rows, loading, fetchRows } = useSiteCorpCardReceiptArchiveData();
...
export default SiteCorpCardReceiptArchiveTab;
